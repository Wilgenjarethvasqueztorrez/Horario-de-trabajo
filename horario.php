...
<head>
  ...
  <link rel="stylesheet" href="src/css/styles.css"> <!-- ✅ Asegúrate que esta ruta sea correcta -->
</head>
<body>
  ...
  <main class="container mt-4">
      ...
      <table class="table table-hover">
        ...
        <tbody>
          <?php
            ...
            $sql = $conexion->query("SELECT * FROM horarios ORDER BY horario ASC");
          ...
          <tr>
            ...
            <td class="acciones">
              ...
              <a href="CRUD/eliminarHorario.php?Id=<?php echo $resultado['id']; ?>" class="btn btn-danger btn-sm">
    ...
    <div class="text-center mt-4">
      <a href="index.php" class="btn btn-primary me-2">Agregar nota</a>
